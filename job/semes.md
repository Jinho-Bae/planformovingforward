...
- 회원관리 기능. 
  ...
  관리자 페이지를 만들어 사용자의 권한과 게시글의 관리를 할 수 있게 했다. 

- Hierarchical Clustering에 대해서?

  가까운 것을 유사하다고 말했을 때, 가장 가까운 것을 한 클러스터로 묶고, 묶은 상태에서 가장 가까운 것을 한 클러스터로 묶는 식으로 반복해서, 사용자가 원하는 개수의 클러스터로 만들 때까지 한다.

- 세메스를 어떻게 알게됐나.

  싸피과정에 채용설명회 왔다. 또한 특강에서도 세메스라는 기업의 매출액이나 비전을 봤을 때 왠만한 기업보다는 훨씬 나은 회사라는 설명을 듣고, 공감했다.

- 하고 싶은 일이나 맡고 싶은 일. 

  설비 제어하는 역할 하고 싶다. 많은 예산과 인력이 들어가는 작업이고, 반도체 관련 SW의 주력 분야라고 생각한다. 기본을 빠르게 배우고 빨리 현재 일에 적응하고 싶다.
